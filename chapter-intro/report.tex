...
The fuel particle is a microsphere of about 0.8 mm diameter consisting of a fuel kernel (either fuel oxide, carbide or a mixture of oxide and carbide) surrounded by a low density carbonaceous layer (the buffer),  followed successively by layers of pyrolytic carbon (PyC), silicon carbide (SiC), and PyC.
