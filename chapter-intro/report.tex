...
Higher outlet temperatures and increased cycle efficiencies enable a wide range of process heat applications.

This technology has the capability of being a clean alternative to fossil fuels.

% Process heat and hydrogen
Steam
Coal gasification processes
Production of Hydrogen
Synthesis to other fuels such as methanol w/ H2(???)
...
Utilizing the \gls{HTGR} as the energy source eliminates the need to burn fossil fuels in order to achieve the heat required by these industrial processes \cite{iaea_current_2001}.
