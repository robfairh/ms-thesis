...
Beginning with \gls{FSV}, the \gls{US} core design included ceramic coated fuel particles embedded within
rods placed in large hexagonal shaped graphite elements \cite{brey_development_2001}.
...
% Advantages of the TRISO particles?
