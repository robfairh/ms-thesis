...
The core consists of an array of hexagonal fuel elements in a cylindrical arrangement \ref{fig:layout}.
...
Figure \ref{fig:layout} shows an axial view of the reactor.
