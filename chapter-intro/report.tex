...
This section provides a description of the MHTGR-350 reactor.
...
\begin{table}[htbp!]
	...
	Reactor Vessel Inner diam.    & 6.55 m              \\ 
	Reactor Vessel Outside diam.  & 6.8 m               \\ 
	Power Density                 & 5.9 MW/m$^3$        \\ \hline
	\end{tabular}
...
Table \ref{tab:corecharac} contains the main characteristics of the core.
...
% which ones are startup and which ones are for control?

\begin{table}[]
% I think I can get rid of this table
	\centering
    \caption{MHTGR350 Core Characteristics \cite{oecd_nea_benchmark_2017}.}
	\begin{tabular}{l|l}
	\hline
	...
	Core radius                       & 297.3 cm   \\
	Height of the active core         & 7.9 m      \\ \hline
	\end{tabular}
	\label{tab:corecharac}
\end{table}
