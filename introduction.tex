This chapter introduces the motivation behind the development of this thesis and summarizes the objectives of the following chapters.
...
After the deployment of these two demonstration reactors came the first \gls{HTGR} prototype plant - the Fort St. Vrain Generating Station.
...
Beginning with Fort St. Vrain, the prismatic HTGRs in the \gls{US} adopted as their fuel large hexagonal-shaped graphite elements with ceramic coated \gls{TRISO} particles embedded within rods \cite{brey_development_2001}, shown in Figure \ref{fig:fsv-b}.
...
\begin{figure}[htbp!]
    ...
    \subfloat[Reactor layout. Image reproduced from \cite{barre_gas-cooled_2010}. \label{fig:fsv-a}]{
        \includegraphics[width=0.45\textwidth]{figures/fsv-core}
    }
    \subfloat[Fuel assembly. Image reproduced from \cite{melese_thermal_1984}. \label{fig:fsv-b}]{
        \includegraphics[width=0.45\textwidth]{figures/fsv-assembly}
    }
    \hfill
...
\begin{figure}[htbp!]
	...
	\caption{GT-MHR layout. Image reproduced from \cite{baxi_evaluation_2008}.}
	\label{fig:gt-mhr}
\end{figure}
...
Modeling and prediction of core thermal-fluid behavior is necessary for assessing the safety characteristics of a reactor.
