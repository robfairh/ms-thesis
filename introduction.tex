...
\begin{figure}[htbp!]
	\centering
	\includegraphics[height=8.5cm]{figures/gt-mhr3}
...
The modular HTGR design adds a low core power density to the safety features of the HTGRs.
...
Its purpose was to burn weapons plutonium, with the long term goal of commercial deployment.
...
The database's aims to share the information with the design, construction, and operation of future HTGRs.
...
The MMR Energy System works as a standalone power plant, as part of microgrids, or to provide process heat for industrial applications \cite{world_nuclear_news_micro_2020}.
...
Chapter \ref{ch:thermalfluids} examines Moltres' ability to predict the temperature profile in prismatic HTGRs accurately.
