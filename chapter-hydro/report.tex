...
The report specifies a set of objective screening criteria used to rate each cycle.
...
Equation \ref{eq:sulfur4} determines the thermal power $P_{TH2}$ required by the hydrogen plant.
