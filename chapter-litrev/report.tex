...
In 1981, a formulation based on nodal expansion methods first demonstrated the feasibility of nodal methods in hexagonal geometries \cite{duracz_nodal_1981}.
...
This algorithm uses the \gls{TIP} and, in contrast to the nodal expansion method, solves the resulting differential equation analytically.
...
Fitzpatrick's thesis \cite{fitzpatrick_developments_1995} tests the method and compares it against other nodal solvers on several benchmark problems.
