...
% sort of intro: tak_numerical_2008
...
Among those models we find the equivalent cylinder model and the unit cell model.
...
The unit cell model does not consider the radial power distribution within the fuel assembly or the bypass flow between assemblies.
...
The commercial code CFX 11 (citation) performed the calculations.
The fuel assembly that the authors chose for the study was from the PMR600, whose reference design is the GT-MHR (citation).
