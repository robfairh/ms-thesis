...
To simplify the set up, the model used uniformly distributed isotopes for the compact.
...
% Mention here or maybe in a summary by the end of the chapter that the first study focused only on the temperature of 300K.
% The second study included 1000K in the analyses but focused on the PBMR.
% Both studies used the homogenized fuel compact model ... 

Both studies used an homogenized fuel compact model.
Such model reduces the complexity of the study.
However, 
Mention CRP
