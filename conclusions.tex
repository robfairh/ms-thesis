...
Conducting this exercise helped to identify Moltres flaws and sets the basis for future work.
...
Additionally, interfacing the neutronics and the thermal-fluids is a crutial step in the multi-physics modeling.
Future work will focus on enabling the use of assembly-level average temperatures to properly model thermal feedback.
