...
The figures also display the difference between Serpent and Moltres results, where $\phi_S$ and $\phi_M$ correspond to Serpent-calculated and Moltres-calculated fluxes.
...
Moltres' power distribution largest relative error is 4.5\% and is located in the outer ring.
