...
Moltres simulation obeyed an eigenvalue convergence tolerance of 10$^{-8}$, defined by equation \ref{eq:moltres-tol}
...
The Moltres simulations obeyed an eigenvalue and a flux convergence tolerance of 10$^{-8}$.
...
The Moltres simulations obeyed an eigenvalue and flux convergence tolerance of 10$^{-8}$.
...
The Moltres simulations obeyed an eigenvalue convergence tolerance of 10$^{-8}$.
