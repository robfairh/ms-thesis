...
Figures \ref{fig:assembly-noLBP-er} and \ref{fig:assembly-LBP-er} show $\Delta_{L-2}$ for the various energy group structures.
...
\begin{figure}[htbp!]
	...
	\hfill
	\caption{Comparison of the MHTGR-350 radial power distribution at 600 K calculated with Serpent and Moltres.}
...
\begin{figure}[htbp!]
	...
	\hfill
	\caption{Comparison of the MHTGR-350 radial power distribution at 1200 K calculated with Serpent and Moltres.}
...
\begin{figure}[htbp!]
	...
	\hfill
	\caption{Comparison of the axial detector flux calculated with Serpent and Moltres at 600 K.}
...
\begin{figure}[htbp!]
	...
	\hfill
	\caption{Comparison of the radial detector flux calculated with Serpent and Moltres at 600 K.}
...
\begin{figure}[htbp!]
	...
	\hfill
	\caption{Comparison of the axial detector flux calculated with Serpent and Moltres at 1200 K.}
...
\begin{align}
    \Delta \rho_{CR} &= \frac{k_{out}-k_{in}}{k_{out}k_{in}} \label{eq:controlrod}
    \intertext{where}
    \Delta \rho_{CR} &= \mbox{control rod worth} [-] \notag \\
    k_{out} &= \mbox{eigenvalue with \gls{CR} out (at position z=911.7 cm)} [-] \notag \\
    k_{in} &= \mbox{eigenvalue with \gls{CR} in (at position z=99 cm)} [-] \notag
		\intertext{and}
