...
Serpent run 5$\times 10^4$ neutrons/cycle, 500 active cycles, and 50 inactive cycles for the calculations.
...
The evaluated parameters were $D_g$, $\Sigma^r_g$, $\nu\Sigma^f_g$, and $\chi^t_g$ (equation \ref{eq:diffusion}).
...
\begin{figure}[htbp!]
	...
	\hfill
	\caption{Relative error of the group constants generated with an homogeneous isotope distribution.}
...
% Preliminary studies: homogeneous vs heterogeneous
...
Serpent run 4$\times 10^5$ neutrons/cycle, 360 active cycles, and 40 inactive cycles for the calculations.
% Number of groups: 26 Table
% Condensation using the structures in Table

% Moltres input file 
% The mesh had % N of elements: 37120
