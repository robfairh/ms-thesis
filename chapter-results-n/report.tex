...
For this reason, we compared the neutron mean free path in the different fuel assembly materials, Table \ref{}.



We obtained the group constants using the homogeneous scheme.
...
We empathize that this was a feasibility study, and the following sections makes a deeper analysis of similar results.
...
\begin{figure}[htbp!]
    ...
    \subfloat[Serpent model geometry.]{
        \includegraphics[width=0.45\textwidth]{figures-assembly/oecd-standard-column-legend}
    }
    \subfloat[Moltres model geometry.]{
        \includegraphics[width=0.45\textwidth]{figures-assembly/3D-assembly-30deg-reflec-meshB2}
    }
	\hfill
...
\begin{table}[htbp!]
  ...
  \toprule
              & Fuel compact  & Moderator  & Coolant  &     \\
  \midrule
  Thermal  		&               &    \\
  Fast 				& 1.37771           &    \\
