...
For such a calculation, we modeled a fuel column of the MHTG-350 and generated the group constants using Serpent.
...
Taking advantage of the problem's symmetry, Moltres modeled only a one-twelfth of the fuel column, Figure \ref{fig:fuelcolumn}.
