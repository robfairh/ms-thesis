...
It also requires the reporting of the power distribution and a neutron-flux map \cite{oecd_nea_benchmark_2017}.
...
Section \ref{sec:bench-bcs} discuss further on the use of periodic and reflective boundary conditions.
