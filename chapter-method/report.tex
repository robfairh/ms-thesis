...
% Hence, a single assembly block calculation with the reflective boundary condition cannot give a reliable homogenized group constant set. \cite{yuk_time-dependent_2020}
...
% This work aims to conduct Exercise 1 of Phase I of the benchmark with Moltres and compare the results with the already published results of the benchmark \cite{oecd_nea_coupled_2020}.
...
\centering
    ...
    \label{tab:LBP}
    \begin{tabular}{@{}l S[table-format=1.3, input-ignore={,}] c}
    \toprule
    \multicolumn{1}{c}{Characteristic} & \multicolumn{1}{c@{}}{Value} & \multicolumn{1}{c@{}}{Units} \\
    \midrule
  Absorber                         & B$_{4}$C              & -         \\
...
% Should I talk about any of these reactors GT-MHR or PMR600?
