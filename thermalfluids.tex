...
\begin{figure}[htbp!]
  \centering
  \includegraphics[width=0.25\linewidth]{figures-thermal/ex3-mesh}
  \hfill
  \caption{Model geometry.}
...
\centering
    ...
    \begin{tabular}{l c}
  \toprule
  Homogenized region & Benchmark sub-domains \\
  \midrule
  Fuel               & 1-220   \\
  Bottom reflector   & 221-224 \\
  Top reflector      & 228-231 \\
  Inner reflector    & 225     \\
  Inner reflector    & 226-227 \\
  \bottomrule
  \end{tabular}
\end{table}
...
\centering
    ...
    \begin{tabular}{l c}
  \toprule
  Group number & Benchmark group number \\
  \midrule
  1 & 1-4   \\
  2 & 5-15  \\
  3 & 16-26 \\
