...
% energy group structure table

% make axial view mesh model geometry
...
% axial temperature - decoupled1 + decoupled2 + coupled
% radial temperature - decoupled1 + decoupled2 + coupled
\begin{figure}[htbp!]
  \centering
    \subfloat[Axial temperature at r= ?? cm.]{
        \includegraphics[width=0.45\textwidth]{figures-thermal/}
    }
