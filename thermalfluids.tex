...
\begin{figure}[htbp!]
  \centering
  \includegraphics[width=0.50\linewidth]{figures-thermal/val-unit-matprop}
  \hfill
...
The Section \ref{sec:fuelcol} focus of analysis was a $1/12^{th}$ section of an HTGR fuel column.
