...
Figure \ref{fig:th-val-unit-model} displays the model geometry and the temperature dependent material properties.
...
\begin{figure}[htbp!]
	\centering
    \subfloat[Axial layout of the model geometry.]{
	...
	\hfill
  \caption{Unit cell model input file parameters.}
