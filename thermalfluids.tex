...
The calculations adopted the mass flow distribution from Sato et al \cite{sato_computational_2010}.
...
The temperature is higher closer to the column center because the bypass-flow causes the center's temperature to rise while reducing the peripheral temperature.
...
Section \ref{sec:meshconverge} studied the feasibility of extending this methodology to larger meshes and analyze the possibility of conducting full-scale simulations.
