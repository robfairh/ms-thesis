...
As the mass flow distributions in Cases 4 and 5 depend on the temperature, the calculations required another level of iterations to obtain the final mass flow distribution.
