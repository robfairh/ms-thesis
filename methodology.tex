...
We determine the friction factor $f$ using equation \ref{eq:churchill} \cite{churchill_friction-factor_1977}.
We calculate the heat transfer coefficient $h$ using the well-known Dittus-Boelter correlation \ref{eq:dittus}.
