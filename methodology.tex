...
All the software built on the MOOSE framework shares a joint code base.
...
Additionally, all codes use \gls{MPI} for parallel communication and allows deployment on massively-parallel cluster-computing platforms.
