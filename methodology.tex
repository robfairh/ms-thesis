...
Moltres simulations use equations \ref{eq:diffusion} and \ref{eq:precursors} to calculate the multiplication factor, the neutron flux, and the radial power distribution in the core.
